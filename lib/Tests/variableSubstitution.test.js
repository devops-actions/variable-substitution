...
describe("Test variable substitution main", () => {
    ...
    it("Valid XML", () => {
        ...
        (0, chai_1.expect)(spy.calledWith("Applying variable substitution on XML file: " + file)).to.be.true;
    });
    it("Valid JSON", () => {
        ...
        (0, chai_1.expect)(spy.calledWith("Applying variable substitution on JSON file: " + file)).to.be.true;
    });
    it("Invalid JSON", () => {
        ...
        (0, chai_1.expect)(spy.calledWith("Applying variable substitution on JSON file: " + file)).to.be.false;
    });
    it("Valid YAML", () => {
        ...
        (0, chai_1.expect)(spy.calledWith("Applying variable substitution on YAML file: " + file)).to.be.true;
    });
    it("Invalid YAML", () => {
        ...
        (0, chai_1.expect)(spy.calledWith("Applying variable substitution on YAML file: " + file)).to.be.false;
    });
});
